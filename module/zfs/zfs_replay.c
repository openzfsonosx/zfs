 ...
 */
static int
zfs_replay_create_acl(zfsvfs_t *zfsvfs, lr_acl_create_t *lracl, boolean_t byteswap)
{
	...
	case TX_CREATE_ACL_ATTR:
        ...
        //zfs_vnop_create
#if 0 // Definitely FIXME, like FBSD zfs_vnops.c
...
zfs_replay_setattr(zfsvfs_t *zfsvfs, lr_setattr_t *lr, boolean_t byteswap)
{
    ...
    //zfs_init_vattr(vap, darwin_attr_mask(lr->lr_mask), lr->lr_mode,
