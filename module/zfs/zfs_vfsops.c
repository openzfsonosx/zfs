...
zfsvfs_create(const char *osname, zfsvfs_t **zfvp)
{
	...
	mutex_init(&zfsvfs->z_reentry_lock, NULL, MUTEX_DEFAULT, NULL);
	...
	list_create(&zfsvfs->z_reentry_threads, sizeof (reentry_threads_t),
	    offsetof(reentry_threads_t, reentry_node));
...
zfsvfs_free(zfsvfs_t *zfsvfs)
{
	...
	mutex_destroy(&zfsvfs->z_reentry_lock);
	list_destroy(&zfsvfs->z_all_znodes);
	list_destroy(&zfsvfs->z_reclaim_znodes);
	list_destroy(&zfsvfs->z_reentry_threads);
