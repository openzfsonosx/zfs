...
OSDefineMetaClassAndStructors(net_lundman_zfs_pseudo_device, IOBlockStorageDevice)

bool
net_lundman_zfs_pseudo_device::init(zvol_state_t *c_zv,
    OSDictionary *properties)
{
	dprintf("pseudo_device:init\n");
...
void  net_lundman_zfs_pseudo_device::registerPool(ZFSProxyMediaScheme *addy)
{
	printf("registerPool(%p)\n", addy);
	pool_proxy = addy;
}
...
bool
net_lundman_zfs_pseudo_device::attach(IOService* provider)
{
...
int
net_lundman_zfs_pseudo_device::getBSDName(void)
{
...
void
net_lundman_zfs_pseudo_device::detach(IOService* provider)
{
...
bool
net_lundman_zfs_pseudo_device::handleOpen(IOService *client,
...
void
net_lundman_zfs_pseudo_device::handleClose(IOService *client,
...
IOReturn
net_lundman_zfs_pseudo_device::doAsyncReadWrite(
...
IOReturn
net_lundman_zfs_pseudo_device::doDiscard(UInt64 block, UInt64 nblks)
{
...
IOReturn
net_lundman_zfs_pseudo_device::doUnmap(IOBlockStorageDeviceExtent *extents,
...
UInt32
net_lundman_zfs_pseudo_device::doGetFormatCapacities(UInt64* capacities,
...
char *
net_lundman_zfs_pseudo_device::getProductString(void)
{
...
IOReturn
net_lundman_zfs_pseudo_device::reportBlockSize(UInt64 *blockSize)
{
...
IOReturn
net_lundman_zfs_pseudo_device::reportMaxValidBlock(UInt64 *maxBlock)
{
...
IOReturn
net_lundman_zfs_pseudo_device::reportMediaState(bool *mediaPresent,
    bool *changedState)
{
...
IOReturn
net_lundman_zfs_pseudo_device::reportPollRequirements(bool *pollRequired,
...
IOReturn
net_lundman_zfs_pseudo_device::reportRemovability(bool *isRemovable)
{
...
IOReturn
net_lundman_zfs_pseudo_device::doEjectMedia(void)
{
	dprintf("ejectMedia\n");
...
IOReturn
net_lundman_zfs_pseudo_device::doFormatMedia(UInt64 byteCapacity)
{
	printf("doFormat\n");
...
IOReturn
net_lundman_zfs_pseudo_device::doLockUnlockMedia(bool doLock)
{
...
IOReturn
net_lundman_zfs_pseudo_device::doSynchronizeCache(void)
{
	dprintf("doSync\n");
	if (zv && zv->zv_zilog) {
...
char *
net_lundman_zfs_pseudo_device::getVendorString(void)
{
	dprintf("getVendor\n");
	return ((char *)"ZFS Pseudo Device");
}
...
char *
net_lundman_zfs_pseudo_device::getRevisionString(void)
{
	dprintf("getRevision\n");
...
char *
net_lundman_zfs_pseudo_device::getAdditionalDeviceInfoString(void)
{
...
IOReturn
net_lundman_zfs_pseudo_device::reportEjectability(bool *isEjectable)
{
...
IOReturn
net_lundman_zfs_pseudo_device::reportLockability(bool *isLockable)
{
	dprintf("reportLocka\n");
	*isLockable = true;
	return (kIOReturnSuccess);
...
IOReturn
net_lundman_zfs_pseudo_device::reportWriteProtection(bool *isWriteProtected)
{
...
IOReturn
net_lundman_zfs_pseudo_device::getWriteCacheState(bool *enabled)
{
...
IOReturn
net_lundman_zfs_pseudo_device::setWriteCacheState(bool enabled)
{
