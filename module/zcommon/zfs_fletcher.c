...
void
fletcher_4_native(const void *buf, uint64_t size, const void *ctx, zio_cksum_t *zcp)
{
...
void
fletcher_4_byteswap(const void *buf, uint64_t size, const void *ctx, zio_cksum_t *zcp)
{
	const fletcher_4_ops_t *ops = fletcher_4_impl_get();
