...
AC_PATH_TOOL(GROUPADD, groupadd, "")
AC_PATH_TOOL(GROUPDEL, groupdel, "")
AC_PATH_TOOL(GROUPMOD, groupmod, "")
AC_PATH_TOOL(CMD_GROUPS, groups, "")
...
AC_PATH_TOOL(TRUNCATE, gtruncate, "")
AC_PATH_TOOL(UMASK, umask, "")
AC_PATH_TOOL(UMOUNT, umount, "")
AC_PATH_TOOL(UNAME, uname, "")
AC_PATH_TOOL(UNIQ, uniq, "")
AC_PATH_TOOL(USERADD, useradd, "")
AC_PATH_TOOL(USERDEL, userdel, "")
AC_PATH_TOOL(USERMOD, usermod, "")
AC_PATH_TOOL(WAIT, wait, "wait") dnl # Builtin in bash
AC_PATH_TOOL(WC, wc, "")
AC_PATH_TOOL(ZDB, zdb, "")
AC_PATH_TOOL(ZFS, zfs, "")
AC_PATH_TOOL(ZHACK, zhack, "")
AC_PATH_TOOL(ZPOOL, zpool, "")
