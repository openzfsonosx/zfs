...
#define	ZFS_IOC_FSGETXATTR	_IOR('X', 31, struct zfsxattr)
#define	ZFS_IOC_FSSETXATTR	_IOW('X', 32, struct zfsxattr)

#define ZFS_FSCTL_FSGETXATTR IOCBASECMD(ZFS_IOC_FSGETXATTR)
#define ZFS_FSCTL_FSSETXATTR IOCBASECMD(ZFS_IOC_FSSETXATTR)
