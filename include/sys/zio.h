...
extern zio_t *zio_read(zio_t *pio, spa_t *spa, const blkptr_t *bp,
    struct abd *data, uint64_t lsize, zio_done_func_t *done, void *_private,
...
extern zio_t *zio_rewrite(zio_t *pio, spa_t *spa, uint64_t txg, blkptr_t *bp,
    struct abd *data, uint64_t size, zio_done_func_t *done, void *_private,
...
extern zio_t *zio_read_phys(zio_t *pio, vdev_t *vd, uint64_t offset,
    ...
    zio_done_func_t *done, void *_private, zio_priority_t priority,
...
extern zio_t *zio_vdev_child_io(zio_t *zio, blkptr_t *bp, vdev_t *vd,
    ...
    zio_done_func_t *done, void *_private);
