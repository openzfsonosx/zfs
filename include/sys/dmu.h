...
int dmu_read_iokit_dbuf(dmu_buf_t *zdb, uint64_t *offset,
    uint64_t position, uint64_t *size, struct iomem *iomem);
int dmu_read_iokit_dnode(dnode_t *dn, uint64_t *offset,
    uint64_t position, uint64_t *size, struct iomem *iomem);
...
int dmu_write_iokit_dnode(dnode_t *dn, uint64_t *offset, uint64_t position,
    uint64_t *size, struct iomem *iomem, dmu_tx_t *tx);
