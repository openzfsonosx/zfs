...
enum zio_stage {
	...
	ZIO_STAGE_READY			= 1 << 17,	/* RWFCI */

	ZIO_STAGE_VDEV_IO_START		= 1 << 18,	/* RW--I */
	ZIO_STAGE_VDEV_IO_DONE		= 1 << 19,	/* RW--I */
	ZIO_STAGE_VDEV_IO_ASSESS	= 1 << 20,	/* RW--I */

	ZIO_STAGE_CHECKSUM_VERIFY	= 1 << 21,	/* R---- */

	ZIO_STAGE_DONE			= 1 << 22	/* RWFCI */
};
