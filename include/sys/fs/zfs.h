...
#define ZFS_IOC_RECV                ZFS_IOC_CMD(27)
#define ZFS_IOC_SEND                ZFS_IOC_CMD(28)
...
#define ZFS_IOC_SMB_ACL             ZFS_IOC_CMD(46)
#define ZFS_IOC_USERSPACE_ONE       ZFS_IOC_CMD(47)
#define	ZFS_IOC_USERSPACE_MANY      ZFS_IOC_CMD(48)
#define ZFS_IOC_USERSPACE_UPGRADE   ZFS_IOC_CMD(49)
#define ZFS_IOC_HOLD                ZFS_IOC_CMD(50)
#define ZFS_IOC_RELEASE             ZFS_IOC_CMD(51)
#define ZFS_IOC_GET_HOLDS           ZFS_IOC_CMD(52)
#define ZFS_IOC_OBJSET_RECVD_PROPS  ZFS_IOC_CMD(53)
#define ZFS_IOC_VDEV_SPLIT          ZFS_IOC_CMD(54)
#define ZFS_IOC_NEXT_OBJ            ZFS_IOC_CMD(55)
#define ZFS_IOC_DIFF                ZFS_IOC_CMD(56)
#define ZFS_IOC_TMP_SNAPSHOT        ZFS_IOC_CMD(57)
#define ZFS_IOC_OBJ_TO_STATS        ZFS_IOC_CMD(58)
#define ZFS_IOC_EVENTS_NEXT         ZFS_IOC_CMD(59)
#define ZFS_IOC_EVENTS_CLEAR        ZFS_IOC_CMD(60)
#define ZFS_IOC_POOL_REGUID         ZFS_IOC_CMD(61)
#define ZFS_IOC_SPACE_WRITTEN       ZFS_IOC_CMD(62)
#define ZFS_IOC_SPACE_SNAPS         ZFS_IOC_CMD(63)
#define ZFS_IOC_POOL_REOPEN         ZFS_IOC_CMD(64)
#define ZFS_IOC_SEND_PROGRESS       ZFS_IOC_CMD(65)
#define ZFS_IOC_OBJSET_ZPLPROPS     ZFS_IOC_CMD(66)
#define ZFS_IOC_DESTROY_SNAPS_NVL   ZFS_IOC_CMD(67)
#define ZFS_IOC_POOL_SCAN           ZFS_IOC_CMD(68)

typedef unsigned int zfs_ioc_t;
